...
\definestructureconversionset [bodypart:sectionnumber][numbers, numbers, numbers][numbers]
\definestructureconversionset [appendix:sectionnumber][numbers, Characters, numbers][numbers]
...
\setuplabeltext[en][
  frontchapter={Chapter\;,\;},
  bodychapter={Chapter\;,\;},
  appendchapter={Appendix\;,},
  backchapter={Chapter\;,\;}
]
\setuplabeltext[en][
...
\setuplist[chapter][
  width=6em,	% setuplist中的設置無效，可能是bug
  margin=0em,	%dimension % 左侧缩进
  label=yes,
]
...
\rlap{} \hfill
  {Chapter\;\getmarking[chapternumber][first]\;\;\getmarking[chapter][first]}
\hfill \llap{}%
}%
}
...
\rlap{} \hfill
  ...
  %  {\getmarking[subject][current]}
    {Section\;\getmarking[sectionnumber][first]\;\;\getmarking[section][first]}
\hfill \llap{}%
}%
}
...
\rlap{\pagenumber\;/\;\lastpagenumber} \hfill  {} \hfill \llap{}%
}}%
\define\BodyTextRightFooter{%
\framedtext[frame=off,topframe=on,width=broad,offset=none,frameoffset=2pt,]{%
\rlap{} \hfill  {\pagenumber} \hfill \llap{\pagenumber\;/\;\lastpagenumber}%
}}%
