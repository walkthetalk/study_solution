-- copied from texlive/texmf-dist/tex/context/base/mkiv/phys-dim.lua

if not modules then modules = { } end modules ['p-phys-dim'] = {
    version   = 1.001,
    comment   = "companion to p-phys-dim.mkiv",
