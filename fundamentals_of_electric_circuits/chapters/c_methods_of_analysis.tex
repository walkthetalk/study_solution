...
% 3.18
\startQ[Q:3.18]
Determine the node voltages in the circuit in \reffig{3.67}
using nodal analysis.
\placefigq{3.67}{3.18}
\stopQ
...
\startA
\startformula\startmathalignment
\NC \NC v_3 = v_1 + 300 \NR
\NC \NC \frac{v_1}{20} + \frac{v_3}{40} = 15 \NR
\NC \NC \frac{v_2 - v_1}{40} + \frac{v_2 - v_3}{40} = 15 \NR
\stopmathalignment\stopformula
