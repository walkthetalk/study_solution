...
\NC 1 - (\frac{n-1}{k})^k \NC \ge \frac{1}{2} \NR
\NC (\frac{n-1}{k})^k     \NC \le \frac{1}{2} \NR
\NC k \lg(\frac{n-1}{n})  \NC \ge \lg\frac{1}{2} \NR
\NC k = \frac{\log(1/2)}{\log(364/365)} \NC \approx 263 \NR
