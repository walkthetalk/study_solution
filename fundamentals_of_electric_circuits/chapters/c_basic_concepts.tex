...
\startMPcode
	snewR.r1 "angle(90)";
	ObjLabel.r1(textext("1")) "labcolor(FireBrick)";

	snewR.r2 "angle(90)";
	ObjLabel.r2(textext("2")) "labcolor(FireBrick)";

	snewR.r4 "angle(90)";
	ObjLabel.r4(textext("4")) "labcolor(FireBrick)";

	snewR.r3 "angle( 0)";
	ObjLabel.r3(textext("3")) "labcolor(FireBrick)";

	r1.c = origin;
	r2.c = r1.c+(30,0);
	r4.c = r2.c+(60,0);
	r3.c = (r2.c+r4.c)/2 + (0,30);
