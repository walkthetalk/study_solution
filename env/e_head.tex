...
%  numbercommand=\PartNbr,
  ...
  after={\blank[1em] \placelist[chapter]}, %COMMAND
...
%  text=nomarking, %none empty high nomarking
  ...
  before={\blank[2em]}, %COMMAND
%  inbetween=, %COMMAND
  after={\blank[1em] \placelist[section,subject]}, %COMMAND
  alternative=middle, %normal inmargin middle TEXT
%  sectionnumber=no,
]
...
\definelayer
  ...
  [preset=middle]
\startsetups layer
\setlayerframed[pagenumber][
  x=\paperwidth-\layerwidth,
  y=\paperheight/2,
  frae=off,
  align=middle]{\headnumber[chapter]}
\stopsetups
...
\setupfootertexts[text]
[]
[\centerline{第\;\pagenumber\;頁，共\;\lastpagenumber\;頁}]
[]
[\centerline{第\;\pagenumber\;頁，共\;\lastpagenumber\;頁}]
