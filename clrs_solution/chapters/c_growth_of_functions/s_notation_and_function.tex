...
初始：
\startformula\startalign
\NC \frac{\phi^0 - \hat\phi^0}{\sqrt{5}} \NC = \frac{1 - 1}{\sqrt{5}} = 0 = F_0 \NR
\NC \frac{\phi - \hat{\phi}}{\sqrt{5}}   \NC = \frac{1 + \sqrt{5} - 1 + \sqrt{5}}{2\sqrt{5}} = 1 = F_1 \NR
\stopalign\stopformula
歸納：
\startformula\startalign
